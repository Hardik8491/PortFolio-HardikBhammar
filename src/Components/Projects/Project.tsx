...
const Testimonials = () => {
  ...
  return (
    <section className="testiWrap  md:pt-[2rem] lg:pt-[2rem] -mt-24 sm:mt[-12rem] md:mt-[-15rem] lg:mt-[-7.625rem] pb-[4.5rem] sm:pb-[5.5rem] md:pb-[6.5rem] lg:pb-[8.75rem] relative w-full">
      <span className="bg-accent absolute right-0 bottom-[-.75rem] h-6 w-1/2"></span>
      <div
