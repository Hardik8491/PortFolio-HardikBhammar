...
import SectionBg from "../../../public/secBg6.9207520b7c9b84cebba8.jpg";
import  {GoDotFill}  from "react-icons/go";
import AboutImg from "../../../public/hardik.jpg";

const AboutUs2 = () => {
  return (
    <section
  
     className="aboutUsWrap py-[4.5rem] md:py-[5.5rem] lg:py-[6.5rem] xl:py-[10.5rem] md:pb-0 relative w-full z-[1]"
     >
      <div
      ...
      ></div>
      <div className=" 2xl:max-w-[110.3125rem] mx-auto">
        <div className="aboutUsInner p-5 md:p-10 lg:pb-0 xl:pt-[6.25rem] relative w-full">
          <div
            className="fixedBg bg-center bg-cover bg-no-repeat before:absolute before:z-[1] before:inset-0 before:opacity-90 before:bg-dark bg-dark gradBg3 bg-blend-overlay rounded-[10px] sm:rounded-[1.25rem] md:rounded-[3.125rem] overflow-hidden"
          ...
          <div className="aboutData grid gap-[1.875rem] lg:grid-cols-2 grid-cols-1 w-full max-w-[75rem] mx-auto">
            ...
            <div>
              <div className="aboutCap relative z-[1] pt-0 xl:pt-5 pl-0 xl:pl-[4rem] pr-0">
                ...
                <h2 className="text-white font-bold text-[1.875rem] md:text-[2.5rem] lg:text-[3rem] xl:text-[3.3ed89rem] leading-normal my-2 md:my-0 font-Poppins uppercase">
                  Hardik <span className="text-accent font-normal">Bhammar</span>
                </h2>
                ...
                <svg
                  ...
                  <div className="h-4 p-4 w-full "> </div>
                {/* About Cap */}
              </div>
            </div>
            {/* About Data */}
